...
class DebtCollectionCallQueue(models.Model):
    ...
    invoice_overdue = models.DecimalField(
        max_digits=10, decimal_places=2, default=0.00)
    ...
    cd_amount = models.DecimalField(
        max_digits=10, decimal_places=2, default=0.00)
    total_cd_amount = models.DecimalField(
        max_digits=10, decimal_places=2, default=0.00)
...
class DebtCollectionCallHistory(models.Model):
    ...
    customer_name = models.CharField(max_length=200, blank=True)
    customer_id = models.CharField(max_length=200, blank=True)
    call_id = models.CharField(max_length=1000, blank=True, default="")
    ...
    conclusion = models.CharField(
        max_length=512, default="Nothing", blank=True)
    call_summary_notes = models.CharField(
